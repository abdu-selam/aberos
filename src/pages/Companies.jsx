...
function Companies() {
    ...
    const subCompanies = [
        {
            name: 'Mall',
            desc1: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci, dolorum.',
            ...
            desc3: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo, quisquam incidunt exercitationem pariatur',
            imgs: [heroImg, heroImg, heroImg, heroImg],
            video: 'https://www.youtube.com/embed/bWzN8NuZWF8?controls=0&modestbranding=1',
        ...
        <>
            ...
            <section className="bg-linear-to-r from-primary to-secondary text-white py-20">
                <div className="max-w-6xl mx-auto px-6 text-center">
                    <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Our Companies</h1>
            ...
            <main className="py-12">
                ...
                {subCompanies.map((com, i) => (
                    ...
                    >
                        <h2 className="text-3xl font-bold text-primary mb-4">{com.name}</h2>
