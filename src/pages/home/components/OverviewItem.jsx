  ...
  return (
    ...
    >
      <figure className="h-full w-full relative">
        ...
        />
        <div
          className={`absolute w-full h-full bg-back/40 top-0 left-0 ${curr !== i && "opacity-0"}`}
        ></div>
        {curr === i && (
          <figcaption className="absolute w-full bottom-0 p-4 bg-linear-0 from-back from-60% to-transparent flex flex-col gap-2">
