...
const Button = ({ children, className="", ...props }) => {
  return (
    <button
      {...props}
      className={`bg-accent p-2 px-4 rounded-lg font-semibold ${className} relative group overflow-hidden hover:scale-102 disabled:hover:scale-100 disabled:opacity-80 transition duration-300`}
    >
      {children}
